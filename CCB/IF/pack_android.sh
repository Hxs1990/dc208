...
do
	(
		...
		do
			...
			if [[ "$fullFileName" == "_alpha_nb_ocean" || "$fullFileName" == "_alpha_decoration" || "$fullFileName" == "_alpha_throne" || "$fullFileName" == "_alpha_World_1" || "$fullFileName" == "_alpha_World_2" || "$fullFileName" == "_alpha_World_4" || "$fullFileName" == "_alpha_World_5" || "$fullFileName" == "_alpha_World_6" ]]; then
            ...
            if [[ "$fullFileName" == "_alpha_World_3" || "$fullFileName" == "_alpha_Imperial_30" || "$fullFileName" == "_alpha_Imperial_31" || "$fullFileName" == "_alpha_Loading_1" || "$fullFileName" == "_alpha_Common_511" || "$fullFileName" == "_alpha_Loading_3" || "$fullFileName" == "_alpha_UIComponent_1" ]]; then
