...
# TexturePacker --texture-format png --png-opt-level 0 --reduce-border-artifacts --opt RGBA8888 --size-constraints AnySize --sheet "$fullFileName.png" --data "$fileName.plist" $tpsFile
...
# TexturePacker --format libgdx --texture-format png --png-opt-level 0 --opt RGBA8888 --size-constraints AnySize --sheet "$fullFileName.png" --data "$fileName.atlas" $tpsFile
...
# TexturePacker --texture-format png --png-opt-level 0 --opt RGBA8888  --scale 0.5 --algorithm Basic --size-constraints AnySize --sheet "$fullFileName.png" --data "$fileName.plist" $tpsFile
