...
//        m_picNode5->removeAllChildren();
    ...
    if(m_a[0]!=-1){
        ...
        if (isPad)
            CCCommonUtils::createGoodsIcon(m_a[0], m_picNode1, CCSize(127*1.7, 127*1.7),m_numLabel1);
        else
            CCCommonUtils::createGoodsIcon(m_a[0], m_picNode1, CCSize(127, 127),m_numLabel1);
    }else{
    ...
    if(m_a[1]!=-1){
        ...
        if (isPad)
            CCCommonUtils::createGoodsIcon(m_a[1], m_picNode2, CCSize(127*1.7, 127*1.7),m_numLabel2);
        else
    ...
    if(m_a[2]!=-1){
        ...
        if (isPad)
            CCCommonUtils::createGoodsIcon(m_a[2], m_picNode3, CCSize(127*1.7, 127*1.7),m_numLabel3);
        else
    ...
    if(m_a[3]!=-1){
        ...
        if (isPad)
            CCCommonUtils::createGoodsIcon(m_a[3], m_picNode4, CCSize(127*1.7, 127*1.7),m_numLabel4);
        else
    ...
    if(isPad && m_a[4]!=-1) {
        ...
        CCCommonUtils::createGoodsIcon(m_a[4], m_picNode5, CCSize(127*1.7, 127*1.7),m_numLabel5);
