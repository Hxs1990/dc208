...
#endif
        ValueMap meta = CCCommonUtils::getHelpShiftDefaultMeta();
        HelpshiftCocos2dx::addProperties(meta);

        ValueVector tags = CCCommonUtils::getHelpShiftDefaultTags();
        string timestr = CCCommonUtils::timeStampToYMD(m_info->createTime);
        tags.push_back(Value(timestr));
        //添加策划反馈标签
        tags.push_back(Value("策划反馈"));
        if (m_info->isBanMail) {
            ////添加被ban邮件回复的标签
...
void MailReadPopUpView::onFbLikeClick(CCObject *pSender, CCControlEvent event){
    if (GlobalData::shared()->isXiaoMiPlatForm()|| GlobalData::shared()->analyticID == "cn1") {
...
//    tempstr = tempstr + "\n";
//    tempstr = tempstr + "亲爱的领主们，\n<a href=\"https://www.facebook.com/\">facebook</a>we are all excepted that you will like it. Thanks. <a href=\"https://www.facebook.com/Dragon-Clans-1484362238534405/\">https://www.facebook.com/Dragon-Clans-1484362238534405/</a>";
