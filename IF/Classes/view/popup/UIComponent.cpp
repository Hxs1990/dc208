...
//    resetGoldActivityBox(NULL);
    ...
    CCSafeNotificationCenter::sharedNotificationCenter()->addObserver(this, callfuncO_selector(UIComponent::onShowFAQ), MSG_SHOW_LOADINGS_FQA, NULL);
...

{
    ...
    CCSafeNotificationCenter::sharedNotificationCenter()->addObserver(this, callfuncO_selector(UIComponent::testFeedCallBack), TESTFEEDBACK_CHECKVERSION, NULL);
...
//    CCSafeNotificationCenter::sharedNotificationCenter()->removeObserver(this, MSG_HAS_NEW_GOOD);
    ...
    CCSafeNotificationCenter::sharedNotificationCenter()->removeObserver(this, TESTFEEDBACK_CHECKVERSION);
...
//    }
        ...
        
    {
        ...
        hintType = 36;
        return true;
    }else if(m_LvBG->isVisible() && PopupViewController::getInstance()->getCurrViewCount()==0   && isTouchInside(m_LvBG, pTouch)){
        hintType = 37;
        return true;
    }
...
//            HelpshiftCocos2dx::showFAQs();
        ...
        case 31:{
            double leftT = TestFeedBackController::shared()->getEndTime() - GlobalData::shared()->getTimeStamp();
            if(leftT>0){
                TestFeedBackSaveCommand* cmd = new TestFeedBackSaveCommand("", 0, "", "", 0, true);
                cmd->sendAndRelease();
            }else{
...
void UIComponent::testFeedCallBack(CCObject* params){
...
void UIComponent::onGoToHelpShift(CCObject* p)
{
    ...
    ValueVector tags;
    tags.push_back(Value("UIComponent:"));
#if (CC_TARGET_PLATFORM == CC_PLATFORM_IOS)
