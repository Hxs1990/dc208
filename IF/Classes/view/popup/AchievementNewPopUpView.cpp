...
void AchievementNewPopUpView::getStageRd()
{
    ...
    GameController::getInstance()->callXCApi("action=questStageRd_click");
    FBUtilies::addEvent_questStageRd_click(); // 打点
}
...
bool RewardShowInfoView::init(CCArray* data)
{
    ...
    do
    {
        ...
        GameController::getInstance()->callXCApi("action=questStageRd_pop");
        FBUtilies::addEvent_questStageRd_pop();  // 打点
