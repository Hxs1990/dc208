...
static const char* icons[10] = {"changeAllianceName.png","alliance_changeFlag.png","alliance_search.png","alliance_view.png","alliance_paihang.png","icon_comment.png","icon_remove_comment.png","icon_alliance_quit.png","dragonBattleBtn.png","alliance_view.png"};
...
cocos2d::CCSize AllianceFunView::gridSizeForTable(cocos2d::extension::CCMultiColTableView *table){
    if (CCCommonUtils::isIosAndroidPad()) {
        return CCSize(452, 306);
    }
    return CCSize(190, 150);
}
