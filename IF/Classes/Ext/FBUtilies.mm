...
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    
    [FBSDKAppEvents logEvent:[NSString stringWithUTF8String: event_name.c_str()] parameters:params];
}
...
void FBUtilies::addEvent_questStageRd_pop()
{
    ...
    [FBSDKAppEvents logEvent:@"questStageRd_pop" parameters:params];
}
void FBUtilies::addEvent_questStageRd_click()
{
    ...
    [FBSDKAppEvents logEvent:@"questStageRd_click" parameters:params];
}
...
void FBUtilies::addEvent_alOrder_open_m()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"alOrder_open_m" parameters:params];
}
void FBUtilies::addEvent_alOrder_open_w()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"alOrder_open_w" parameters:params];
}
void FBUtilies::addEvent_alOrder_cmd(int cmd)
{
    ...
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:[NSString stringWithCString: tmp] parameters:params];
}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"alOrder_cmd_1" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"alOrder_cmd_2" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"alOrder_cmd_3" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"alOrder_cmd_4" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"alOrder_cmd_5" parameters:params];
//}
...
void FBUtilies::addEvent_newPlayer_7rwd_pop()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"newPlayer_7rwd_pop" parameters:params];
}
void FBUtilies::addEvent_newPlayer_7rwd_click()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"newPlayer_7rwd_click" parameters:params];
}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"newplayer_7rwd_1" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"newplayer_7rwd_2" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"newplayer_7rwd_3" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"newplayer_7rwd_4" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"newplayer_7rwd_5" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"newplayer_7rwd_6" parameters:params];
//}
...
void FBUtilies::addEvent_loginDay_7rwd_pop()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"loginDay_7rwd_pop" parameters:params];
}
void FBUtilies::addEvent_loginDay_7rwd_click()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"loginDay_7rwd_click" parameters:params];
}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"loginDay_7rwd_1" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"loginDay_7rwd_2" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"loginDay_7rwd_3" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"loginDay_7rwd_4" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"loginDay_7rwd_5" parameters:params];
//}
...
//                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
//                                   nil];
//    [FBSDKAppEvents logEvent:@"loginDay_7rwd_6" parameters:params];
//}
...
void FBUtilies::addEvent_joinAllianceTip_close()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"joinAllianceTip_close" parameters:params];
}
void FBUtilies::addEvent_joinAllianceTip_open()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"joinAllianceTip_open" parameters:params];
}
void FBUtilies::addEvent_joinAllianceTip_join()
{
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithObjectsAndKeys:
                                   [NSString stringWithUTF8String:GlobalData::shared()->playerInfo.uid.c_str()], @"player_uuid",
                                   nil];
    [FBSDKAppEvents logEvent:@"joinAllianceTip_join" parameters:params];
}
...
- (void)gameRequestDialog:(FBSDKGameRequestDialog *)gameRequest didCompleteWithResults:(NSDictionary *)results
{
    ...
    NSArray* tofriends = [results objectForKey:@"to"];
    NSString *requestId = [results objectForKey:@"request"];
    cocos2d::CCString* reqID = cocos2d::CCString::create([requestId UTF8String]);
    CCUserDefault::sharedUserDefault()->setStringForKey(FB_RequestID, reqID->getCString());
    CCUserDefault::sharedUserDefault()->flush();
    
    
    NSString *selFriends = [[NSMutableString alloc] init];
    for (NSString* value in tofriends) {
        if ([selFriends length]) {
            [selFriends appendString:@","];
        }
...
//    [friendCache prefetchAndCacheForSession:nil];
    ...
    gameRequestContent.recipients = array;
...
- (void)openFBSession
{
    if(!FBUtilies::fbIsLogin()){
        NSArray *permissions = [[NSArray alloc] initWithObjects:
                                ...
                                nil];
        FBSDKLoginManager *login = [[FBSDKLoginManager alloc] init];
        login.loginBehavior = FBSDKLoginBehaviorWeb;//游戏内弹出登录页面
...
//        }
        [login logInWithReadPermissions:permissions fromViewController:self.view.window.rootViewController handler:^(FBSDKLoginManagerLoginResult *result, NSError *error) {
            if (error) {
                fbPreRequest = 0;
...
//                                        login.loginBehavior = FBSDKLoginBehaviorBrowser;
//                                    }
                                    [lManager logInWithPublishPermissions:@[@"publish_actions"] fromViewController:self.view.window.rootViewController handler:^(FBSDKLoginManagerLoginResult *result, NSError *error) {
