...
namespace CCCommonUtils {
    enum InitOperations{
        ...
        InitImperialSceneEnd = InitImperialSceneBegin + 13,
...
public:
    ...
    static cocos2d::ValueMap getHelpShiftDefaultMeta(){
        return CCCommonUtils::getHelpShiftDefaultMeta();
    }
    static cocos2d::ValueVector getHelpShiftDefaultTags(){
        return CCCommonUtils::getHelpShiftDefaultTags();
    }
