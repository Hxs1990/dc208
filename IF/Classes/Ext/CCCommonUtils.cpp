...
#if CC_TARGET_PLATFORM==CC_PLATFORM_ANDROID
    CCLog("refreshOpenUUID");
    cocos2d::extension::CCDevice::saveAndroidUDID("");
#endif
}
...
void CCCommonUtils::showEmulatorBanHelpShift(){
    ...
    ValueVector tags;
    tags.push_back(Value("EmulatorBan"));
    meta[HS_TAGS_KEY] = tags;
...
//    ValueVector forms;
//   
//    ValueMap sectionMapA;
//    sectionMapA[HS_FLOW_TYPE] = HS_FAQ_SECTION_FLOW;
//    sectionMapA[HS_FLOW_TITLE] = Value("Section1");
//    sectionMapA[HS_FLOW_DATA] = Value("574");
//    forms.push_back(Value(sectionMapA));
//    
//    ValueMap sectionMapB;
//    sectionMapB[HS_FLOW_TYPE] = HS_FAQ_SECTION_FLOW;
//    sectionMapB[HS_FLOW_TITLE] = Value("Section2");
//    sectionMapB[HS_FLOW_DATA] = Value("465");
//    forms.push_back(Value(sectionMapB));
//    
//    ValueMap sectionMapC;
//    sectionMapC[HS_FLOW_TYPE] = HS_FAQ_SECTION_FLOW;
//    sectionMapC[HS_FLOW_TITLE] = Value("Section3");
//    sectionMapC[HS_FLOW_DATA] = Value("720");
//    forms.push_back(Value(sectionMapC));
//    
//    ValueMap sectionMapD;
//    sectionMapD[HS_FLOW_TYPE] = HS_FAQ_SECTION_FLOW;
//    sectionMapD[HS_FLOW_TITLE] = Value("Section4");
//    sectionMapD[HS_FLOW_DATA] = Value("571");
//    forms.push_back(Value(sectionMapD));
//    
//    ValueMap sectionMapE;
//    sectionMapE[HS_FLOW_TYPE] = HS_FAQ_SECTION_FLOW;
//    sectionMapE[HS_FLOW_TITLE] = Value("Section5");
//    sectionMapE[HS_FLOW_DATA] = Value("459");
//    forms.push_back(Value(sectionMapE));
//    
//    
//    ValueVector formsB;
//
//    ValueMap conversationA;
//    conversationA[HS_FLOW_TYPE] = HS_CONVERSATION_FLOW;
//    conversationA[HS_FLOW_TITLE] = Value("Account");
//  
//    formsB.push_back(Value(conversationA));
//    
//    ValueMap conversationB;
//    conversationB[HS_FLOW_TYPE] = HS_CONVERSATION_FLOW;
//    conversationB[HS_FLOW_TITLE] = Value("Recharge");
//    
//    formsB.push_back(Value(conversationB));
//    
//    ValueMap conversationC;
//    conversationC[HS_FLOW_TYPE] = HS_CONVERSATION_FLOW;
//    conversationC[HS_FLOW_TITLE] = Value("Bug");
//    
//    formsB.push_back(Value(conversationC));
//
//    forms.push_back(Value(formsB));
//    
//    HelpshiftCocos2dx::showDynamicForm("COK", forms);

}

void CCCommonUtils::sendHelpshiftLog(const char* IP, const char* uid, const char* tag)
{
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID && IS_OPEN_PING_HELPSHIFT)
    
    HelpshiftCocos2dx::sendHelpshiftLog(IP, uid, tag);
